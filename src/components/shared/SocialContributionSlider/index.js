...
const SocialContributionSlider = ({ data, type }) => {
  ...
  const { title, heading, subtext } = data;
  return (
    <div>
      <section className="contribution py-80">
          ...
          <div className="social-wrapper">
            <div className="row">
              <div className="col-md-12 blog">
                <Slider ref={sliderRef} type={type} data={data.sliderData} />
              </div>
            </div>
...
export default SocialContributionSlider;
