...
const TestimonialSlider = ({ allData }) => {
  const { heading, subHeading, description, sliderType, data } = allData;
  ...
  return (
    <section className="testimonial py-80 job">
      <div className="container">
        <div className="row">
          <div className="col-md-12 col-lg-12 col-xl-4">
            ...
            <div className="slider-button-block d-none d-lg-block">
